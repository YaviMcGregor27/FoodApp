...
import { type PerfilEnergetico, estimarEnergia, sugerirNivelActividad, tendenciaPeso, ADVERTENCIA_SITUACION } from '../dominio/energia.ts';
import { validarNutrientes, nutrientesReceta } from '../dominio/nutricion.ts';
